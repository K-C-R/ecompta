package com.edefence.ecompta.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.edefence.ecompta.service.EmailAlreadyUsedException ||
            ex instanceof com.edefence.ecompta.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.edefence.ecompta.service.InvalidPasswordException
