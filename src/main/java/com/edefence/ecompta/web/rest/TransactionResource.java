...
import com.edefence.ecompta.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link com.edefence.ecompta.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransactionResource {
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getLibelle() != null) {
                    existingTransaction.setLibelle(transaction.getLibelle());
                }
    ...
    public List<Transaction> getAllTransactions() {
        log.debug("REST request to get all Transactions", transactionRepository.findAllWithEagerRelationships());
        // if (eagerload) {
